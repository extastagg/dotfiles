...
let g:coc_global_extensions = ['coc-json', 'coc-git', 'coc-go', 'coc-toml', 'coc-rust-analyzer', 'coc-clangd', 'coc-tsserver', 'coc-pyright', 'coc-markdownlint', 'coc-java', 'coc-groovy']
